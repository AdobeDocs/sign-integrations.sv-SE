...
| file_hash__c | File Hash | Sträng (50) | Innehåller md5-kontrollsumman för filen som har skickats till Adobe Acrobat Sign |
...
| event_type__c | Händelsetyp | Sträng | Holds the Adobe Acrobat Sign event’s type |
| name__v | Namn | Sträng | Auto-generated event name |
...
1. Lägg till de två delade fälten i alla dokumenttyper som är berättigade till Adobe Acrobat-signatur. To do so, in the Base Document page, select **[!UICONTROL Add]** > **[!UICONTROL Existing Shared Field]** from the top-right corner.
...
### Steg 10. Update document lifecycle {#document-lifecycle}
